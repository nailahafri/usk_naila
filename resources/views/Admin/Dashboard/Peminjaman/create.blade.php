  ...
  <section class="section main-section">
    ...
    <div class="card mb-6">
      ...
      <div class="card-content">
        <form method="post" action="/dashboard/entri-peminjaman">
            @csrf
          <div class="field">
              <div class="field-body">
                ...
                <div class="control icons-left">
                  <input class="input" type="text" disabled value='{{ auth()->guard('admin')->user()->f_nama }}' placeholder="Admin">
              ...
              <div class="field">
                ...
                <div class="control icons-left icons-right">
                  <input class="input" type="date" value='{{ old('f_tanggalpeminjaman') }}' onfocus="this.showPicker()" placeholder="Tanggal Peminjaman" name="f_tanggalpeminjaman">
                ...
                <div class="control">
                  <div class="select">
                    <select id="select1" name="f_idanggota">
                      <option value="" disabled {{ old('f_idanggota') ? '' : 'selected' }}>Pilih Anggota</option>
                      @foreach( $anggotas as $anggota )
                        @if (old('f_idanggota') == $anggota->f_id)
                ...
                <div class="control">
                  <div class="select">
                    <select id="select2" name="f_iddetailbuku">
                      <option value="" disabled {{ old('f_iddetailbuku') ? '' : 'selected' }}>Pilih Buku</option>
                      @foreach( $bukus as $buku )
                        @if (old('f_iddetailbuku') == $buku->f_id)
